...
/-! A bare-chain forest OTS with an equivalent RV64IM verifier, at most 393 cycles on every
execution. -/
...
refinement on every input, and at most 393 cycles on every execution. -/
theorem certificate : submission.Certificate 393 := RiscvUpperForest.machineCertificate

/-- Instructions and embedded data together occupy strictly less than 1 MiB: `4 · 12493 + 104`
bytes. -/
