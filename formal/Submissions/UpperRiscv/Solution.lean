...
/-! A bare-chain forest OTS with an equivalent RV64IM verifier, at most 426 cycles on every
execution. -/
...
refinement on every input, and at most 426 cycles on every execution. -/
theorem certificate : submission.Certificate 426 := RiscvUpperForest.machineCertificate
