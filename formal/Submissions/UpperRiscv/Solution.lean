...
/-! A bare-chain forest OTS with an equivalent RV64IM verifier, at most 359 cycles on every
execution. -/
...
refinement on every input, and at most 359 cycles on every execution. -/
theorem certificate : submission.Certificate 359 := RiscvUpperForest.machineCertificate

/-- The fixed image occupies 49,452 bytes, strictly less than 1 MiB. -/
