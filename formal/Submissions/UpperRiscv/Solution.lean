...
/-! A bare-chain forest OTS with an equivalent RV64IM verifier, at most 377 cycles on every
execution. -/
...
refinement on every input, and at most 377 cycles on every execution. -/
theorem certificate : submission.Certificate 377 := RiscvUpperForest.machineCertificate

/-- The fixed image occupies 61,752 bytes, strictly less than 1 MiB. -/
