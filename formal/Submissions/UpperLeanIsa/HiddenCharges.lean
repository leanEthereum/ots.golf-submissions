...
private theorem word_putSource_zero (ξ : Record) (i : Fin 34) (x : Word) :
    (ξ.putSource i x).word i 0 = x := by
  simp only [Record.word, Fin.val_zero, dite_true, Record.putSource, Function.update_self]

private theorem word_putAnswer_prev (ξ : Record) (i : Fin 34) (j : Fin 256)
...
theorem hidden_word_charge (d : Cut) (v : PublicData) (i : Fin 34) (j : Fin 256)
  ...
  · let p : Fin 255 := ⟨j.val - 1, by have := j.isLt; omega⟩
...
theorem record_chain_query_eq_iff (ξ ζ : Record) (i : Fin 34) (j : Fin 255) :
