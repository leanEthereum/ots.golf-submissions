...
def Record.putSource (ξ : Record) (i : Fin 34) (x : Word) : Record :=
...
theorem putSource_get (ξ : Record) (i : Fin 34) (x : Word) : (ξ.putSource i x).1 i = x :=
  Function.update_self _ _ _

theorem putAnswer_get (ξ : Record) (a : HashLocation) (x : BitVec hashBits) :
    (ξ.putAnswer a x).2 a = x := Function.update_self _ _ _

theorem putSource_restore (ξ : Record) (i : Fin 34) (x : Word) :
...
abbrev Cut := Fin 34 → Fin 256
abbrev PublicData := (Fin 34 → Option Word) × (HashLocation → Option (BitVec hashBits))

def beforeSigning : Cut := fun _ => 255
...
theorem publicData_putSource (d : Cut) (ξ : Record) (i : Fin 34) (x : Word)
...
theorem publicData_putAnswer (d : Cut) (ξ : Record) (i : Fin 34) (j : Fin 255)
...
theorem fiber_closed_source (d : Cut) (v : PublicData) (i : Fin 34) (hi : 0 < (d i).val) :
...
theorem fiber_closed_answer (d : Cut) (v : PublicData) (i : Fin 34) (j : Fin 255)
    (hj : j.val + 1 < (d i).val) :
