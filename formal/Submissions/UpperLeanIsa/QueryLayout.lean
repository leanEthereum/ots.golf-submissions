...
def rootInput (remaining : Fin 34) (cv : BitVec 256) (x : Word) : BitVec 896 :=
  LeanIsa.hashInput cv (x.setWidth 512) (BitVec.ofNat 128 (2 + remaining.val))

private theorem root_tag_injective {r s : Fin 34}
...
theorem rootInput_eq_iff (r s : Fin 34) (cv dv : BitVec 256) (x y : Word) :
...
theorem chainInput_ne_rootInput (i j : ℕ) (x : Word) (r : Fin 34)
...
theorem chainInput_eq_iff (i k : Fin 34) (j l : Fin 255) (x y : Word) :
