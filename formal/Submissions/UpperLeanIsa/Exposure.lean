...
private theorem data_source_eq (d : Cut) (ξ ζ : Record)
    (h : publicData d ξ = publicData d ζ) (i : Fin 43) (hi : (d i).val = 0) :
    ξ.1 i = ζ.1 i := by
...
private theorem data_chain_eq (d : Cut) (ξ ζ : Record)
    (h : publicData d ξ = publicData d ζ) (i : Fin 43) (j : Fin 127)
...
theorem exposed_query_eq (d : Cut) (ξ ζ : Record)
  ...
  | inr i =>
    ...
    · let p : Fin 43 := ⟨i.val - 1, by have := i.isLt; omega⟩
